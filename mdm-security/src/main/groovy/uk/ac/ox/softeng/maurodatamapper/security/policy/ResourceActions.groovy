...
class ResourceActions {
    ...
    public static final List<String> MODEL_EDITOR_ACTIONS = MODEL_AUTHOR_ACTIONS + MODEL_EDITOR_VERSIONING_ACTIONS + [UPDATE_ACTION, SAVE_ACTION, SOFT_DELETE_ACTION, CAN_BE_FINALISED_ACTION]
    ...
    public static final List<String> MODELITEM_DISALLOWED_ACTIONS = [SOFT_DELETE_ACTION, CAN_BE_FINALISED_ACTION]
