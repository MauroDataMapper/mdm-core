...
import uk.ac.ox.softeng.maurodatamapper.core.model.facet.RuleAware
import uk.ac.ox.softeng.maurodatamapper.util.Utils

/**
 * @since 19/11/2020
 */
class RuleAwareMappingContext extends CatalogueItemJoinTableDynamicHibernateMappingContext {
    @Override
    boolean handlesDomainClass(Class domainClass) {
        Utils.parentClassIsAssignableFromChild(RuleAware, domainClass)
    }
