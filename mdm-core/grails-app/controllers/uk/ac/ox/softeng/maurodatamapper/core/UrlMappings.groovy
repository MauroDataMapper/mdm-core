           ...
           */
            ...
            group "/$resourceDomainType/$resourceId", {
                ...
                */
                ...
                get "/domainExports/$exporterNamespace/$exporterName/$exporterVersion?"(controller: 'domainExport', action: 'index')
            }
            ...
            */
            group '/tree', {
                group "/$containerDomainType", {
                    ...
                    get "/${containerId}/ancestors"(controller: 'treeItem', action: 'containerAncestors')
