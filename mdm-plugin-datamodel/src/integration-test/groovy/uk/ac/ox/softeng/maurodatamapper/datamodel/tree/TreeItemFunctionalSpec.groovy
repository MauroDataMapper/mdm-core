...
class TreeItemFunctionalSpec extends BaseFunctionalSpec {
  ...
  },
  {
    ...
    "path": "fo:Functional Test Import Test Folder",
    "hasChildren": true,
    "availableActions": [],
    "deleted": false
  }
      ...
      },
      {
        ...
        "path": "dm:Functional Test DataModel 2$main",
        "hasChildren": false,
        "availableActions": [],
        "deleted": false,
        "finalised": false,
        ...
        verifyJsonResponse(OK,  '''[
      {
        ...
        "path": "dm:Functional Test Imported DataModel$main",
        "hasChildren": true,
        "availableActions": [],
        "deleted": false,
        "finalised": false,
      ...
      },
      {
        ...
        "path": "dm:Functional Test Importing DataModel$main",
        "hasChildren": true,
        "availableActions": [],
        "deleted": false,
        "finalised": false,
    ...
    "children": [
      {
        ...
        "domainType": "DataModel",
        "label": "Functional Test Model deleted",
        "path": "dm:Functional Test Model deleted$1.0.0",
        "modelVersion": "1.0.0",
        "hasChildren": false,
        "availableActions": [],
        "deleted": true,
    ...
    "children": [
      {
        ...
        "domainType": "DataModel",
        "label": "Functional Test Model doc superseded",
        "path": "dm:Functional Test Model doc superseded$1.0.0",
        "modelVersion": "1.0.0",
        "hasChildren": false,
        "availableActions": [],
        "deleted": false,
...
'''
        ...
        "children": [
          {
            ...
            "domainType": "DataModel",
            "label": "Functional Test Model model superseded",
            "path": "dm:Functional Test Model model superseded$1.0.0",
            "modelVersion": "1.0.0",
            "hasChildren": false,
            "availableActions": [],
            "deleted": false,
        ...
        verifyJsonResponse(OK, '''[
  {
    ...
    "path": "dm:Functional Test Importing DataModel$main|dc:Functional Test Importing Parent DataClass",
    "hasChildren": false,
    "availableActions": [],
    "modelId": "${json-unit.matches:id}"
  },
  {
    ...
    "path": "dm:Functional Test Imported DataModel$main|dc:Functional Test Imported Parent DataClass",
    "hasChildren": true,
    "availableActions": [],
    "modelId": "${json-unit.matches:id}",
    "imported": true
        ...
        verifyJsonResponse(OK, '''[
  {
    ...
    "path": "dm:Functional Test Imported DataModel$main|dc:Functional Test Imported Parent DataClass|dc:Functional Test Imported Child DataClass",
    "hasChildren": false,
    "availableActions": [],
    "modelId": "${json-unit.matches:id}",
