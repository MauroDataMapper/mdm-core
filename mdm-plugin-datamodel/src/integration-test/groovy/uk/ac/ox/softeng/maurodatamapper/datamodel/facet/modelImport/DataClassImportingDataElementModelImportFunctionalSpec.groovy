...
/**
 * Where facet owner is a DataClass and it imports a DataElement
 *
...
class DataClassImportingDataElementModelImportFunctionalSpec extends CatalogueItemModelImportFunctionalSpec {
    ...
    @Shared
    DataElement importedDataElement
    ...
    @Transactional
    String getImportedDataElementId() {
        DataElement.findByLabel('Imported DataElement').id.toString()
    }       
    ...
    def checkAndSetupData() {
        ...
        importedDataElement = new DataElement(label: 'Imported DataElement', createdBy: 'functionalTest@test.com',
                                              dataType: importedDataType, dataClass: importedParentDataClass).save(flush: true)                                                                                            
    ...
    def cleanupSpec() {
        ...
        cleanUpResources(DataModel, Folder, DataClass, DataElement, DataType, PrimitiveType, ModelImport)
    }
    ...
    Map getValidJson() {
        [
            ...
            importedCatalogueItemId         : getImportedDataElementId()
        ]
    }
  ...
  "importedCatalogueItem": {
    ...
    "breadcrumbs": [
      ...
      {
        "id": "${json-unit.matches:id}",
        "label": "Imported Parent DataClass",
        "domainType": "DataClass"
      }
    ]
  }
