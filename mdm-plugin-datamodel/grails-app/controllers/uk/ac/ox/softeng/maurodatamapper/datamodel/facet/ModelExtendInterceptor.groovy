...
class ModelExtendInterceptor implements MdmInterceptor {
    ...
    void resourceChecks() {
        ...
        checkAdditionalIds()
        mapDomainTypeToClass('modelItem', true)
    }
    ...
    Model getOwningModel() {
        ModelItem modelItem = findModelItemByDomainTypeAndId(params.modelItemClass, params.modelItemId)
        modelItem.getModel()
    }
