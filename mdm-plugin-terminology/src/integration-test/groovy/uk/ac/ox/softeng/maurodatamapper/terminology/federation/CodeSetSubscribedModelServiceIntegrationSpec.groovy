 ...
 */
package uk.ac.ox.softeng.maurodatamapper.terminology.federation
...
@Integration
@Rollback
class CodeSetSubscribedModelServiceIntegrationSpec extends BaseSubscribedModelServiceIntegrationSpec<CodeSet> {
