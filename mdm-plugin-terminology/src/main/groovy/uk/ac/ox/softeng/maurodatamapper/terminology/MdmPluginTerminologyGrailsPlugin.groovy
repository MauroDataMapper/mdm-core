...
import uk.ac.ox.softeng.maurodatamapper.terminology.gorm.mapping.MdmPluginTerminologySchemaMappingContext
...
class MdmPluginTerminologyGrailsPlugin extends Plugin {
    ...
    def description = 'The Terminology domain, services and controllers for the Mauro Data Mapper backend.'
    ...
    // Location of the plugin's issue tracker.code_set_term
    ...
    Closure doWithSpring() {
        {->
            mdmPluginTerminologySchemaMappingContext MdmPluginTerminologySchemaMappingContext
        }
    }
}
