...
CREATE INDEX subscribed_model_subscribed_catalogue_id ON federation.subscribed_model(subscribed_catalogue_id);
CREATE INDEX subscribed_model_local_model_id ON federation.subscribed_model(local_model_id);
