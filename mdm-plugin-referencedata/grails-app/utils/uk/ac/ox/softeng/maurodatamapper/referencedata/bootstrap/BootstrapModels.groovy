...
class BootstrapModels {
    ...
    static ReferenceDataModel buildAndSaveExampleReferenceDataModel(MessageSource messageSource, Folder folder, Authority authority) {
        ...
        (1..100).each {
            referenceDataModel
                .addToReferenceDataValues(new ReferenceDataValue(referenceDataElement: organisationName, value: "Organisation ${it}", rowNumber: it, createdBy: DEVELOPMENT))
            referenceDataModel
                .addToReferenceDataValues(new ReferenceDataValue(referenceDataElement: organisationCode, value: "ORG${it}", rowNumber: it, createdBy: DEVELOPMENT))
        }
