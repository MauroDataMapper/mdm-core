...
import uk.ac.ox.softeng.maurodatamapper.referencedata.facet.SummaryMetadataInterceptor
import uk.ac.ox.softeng.maurodatamapper.test.unit.interceptor.VariableContainedResourceInterceptorSpec

import grails.testing.web.interceptor.InterceptorUnitTest

class SummaryMetadataInterceptorSpec extends VariableContainedResourceInterceptorSpec implements InterceptorUnitTest<SummaryMetadataInterceptor> {

    def setup() {
        mockDomains(DataModel)
    }
