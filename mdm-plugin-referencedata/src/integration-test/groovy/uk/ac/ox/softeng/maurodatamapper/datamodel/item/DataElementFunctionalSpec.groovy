...
/**
 * @see uk.ac.ox.softeng.maurodatamapper.referencedata.item.DataElementController* Controller: dataElement
...
@Integration
@Slf4j
class DataElementFunctionalSpec extends ResourceFunctionalSpec<DataElement> {
