...
@Integration
@Slf4j
class DataClassReferenceSummaryMetadataReportFunctionalSpec extends CatalogueItemReferenceSummaryMetadataReportFunctionalSpec {
    ...
    def cleanupSpec() {
        ...
        cleanUpResources(DataModel, Folder, DataClass, ReferenceDataElement, ReferenceDataType, SummaryMetadata)
    }
