...
@Integration
@Slf4j
class DataTypeSummaryMetadataReportFunctionalSpec extends CatalogueItemSummaryMetadataReportFunctionalSpec {
    ...
    def checkAndSetupData() {
        ...
        summaryMetadata = new SummaryMetadata(label: 'Functional Test Summary Metadata', createdBy: StandardEmailAddress.FUNCTIONAL_TEST,
                                              catalogueItem: dataType, summaryMetadataType: SummaryMetadataType.NUMBER).save(flush: true)
