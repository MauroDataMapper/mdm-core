...
/**
 * @see uk.ac.ox.softeng.maurodatamapper.referencedata.facet.summarymetadata.SummaryMetadataReportController
 */
@Integration
@Slf4j
class DataClassSummaryMetadataReportFunctionalSpec extends CatalogueItemSummaryMetadataReportFunctionalSpec {
    ...
    def checkAndSetupData() {
        ...
        summaryMetadata = new SummaryMetadata(label: 'Functional Test Summary Metadata', createdBy: StandardEmailAddress.FUNCTIONAL_TEST,
                                              catalogueItem: dataClass, summaryMetadataType: SummaryMetadataType.NUMBER).save(flush: true)
    ...
    def cleanupSpec() {
        ...
        cleanUpResources(DataModel, Folder, DataClass, DataElement, DataType, SummaryMetadata)
    }
