...
INNER JOIN SourceFlowDataModel.tableC c ON b.columnE1 = c.columnE2''')
                    ...
                    .addToDataElementComponents(
                        new DataElementComponent(label: 'CONCAT 1', createdBy: DEVELOPMENT, definition: 'CONCAT(b.columnG,\'_\',c.columnJ)')
...
END''')
                    ...
                    .addToDataElementComponents(
                        new DataElementComponent(label: 'CONCAT 2', createdBy: DEVELOPMENT,
