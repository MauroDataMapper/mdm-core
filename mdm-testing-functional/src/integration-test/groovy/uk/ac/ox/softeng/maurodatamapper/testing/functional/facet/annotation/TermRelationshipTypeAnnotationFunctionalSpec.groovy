...
@Integration
@Slf4j
class TermRelationshipTypeAnnotationFunctionalSpec extends CatalogueItemAnnotationFunctionalSpec {
    ...
    String getCatalogueItemId() {
        TermRelationshipType.byTerminologyIdAndLabel(Utils.toUuid(getModelId()), 'narrowerThan').get().id.toString()
    }
