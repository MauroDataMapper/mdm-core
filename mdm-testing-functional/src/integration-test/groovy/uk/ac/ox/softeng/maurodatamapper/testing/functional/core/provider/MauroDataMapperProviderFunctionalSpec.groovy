 ...
 * </pre>
 * @see uk.ac.ox.softeng.maurodatamapper.core.provider.MauroDataMapperProviderController
 */
@Integration
@Slf4j
class MauroDataMapperProviderFunctionalSpec extends FunctionalSpec {
  ...
  {
    "name": "mdm.pluginAuthenticationApiKey",
    "version": "${json-unit.matches:version}"
  },
  {
    "name": "mdm.pluginAuthenticationBasic",
     "version": "${json-unit.matches:version}"
  },
  {
    "name": "mdm.pluginDataflow",
     "version": "${json-unit.matches:version}"
  },
  {
    "name": "mdm.pluginDatamodel",
     "version": "${json-unit.matches:version}"
  },
  {
