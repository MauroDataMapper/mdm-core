...
@Integration
@Slf4j
class TermAnnotationFunctionalSpec extends CatalogueItemAnnotationFunctionalSpec {
    ...
    String getCatalogueItemId() {
        Term.byTerminologyIdAndCode(Utils.toUuid(getModelId()), 'CTT1').get().id.toString()
    }
