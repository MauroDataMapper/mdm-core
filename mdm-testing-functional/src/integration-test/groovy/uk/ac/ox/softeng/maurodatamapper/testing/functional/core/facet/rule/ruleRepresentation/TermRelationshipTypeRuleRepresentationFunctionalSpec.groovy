...
@Integration
@Slf4j
class TermRelationshipTypeRuleRepresentationFunctionalSpec extends CatalogueItemRuleRepresentationFunctionalSpec {
    ...
    CatalogueItem getCatalogueItem() {
        TermRelationshipType.byTerminologyIdAndLabel(Utils.toUuid(getModelId()), 'narrowerThan').get()
    }
