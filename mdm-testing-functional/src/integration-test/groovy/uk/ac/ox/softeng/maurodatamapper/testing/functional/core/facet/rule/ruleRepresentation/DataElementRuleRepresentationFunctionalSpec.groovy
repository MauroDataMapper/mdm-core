...
@Integration
@Slf4j
class DataElementRuleRepresentationFunctionalSpec extends CatalogueItemRuleRepresentationFunctionalSpec {
    ...
    CatalogueItem getCatalogueItem() {
        DataElement.byDataClassIdAndLabel(Utils.toUuid(getContentDataClassId()), 'ele1').get()
    }
