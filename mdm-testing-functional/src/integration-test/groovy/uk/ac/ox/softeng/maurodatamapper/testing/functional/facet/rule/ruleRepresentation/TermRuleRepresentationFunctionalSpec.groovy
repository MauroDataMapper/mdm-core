...
@Integration
@Slf4j
class TermRuleRepresentationFunctionalSpec extends CatalogueItemRuleRepresentationFunctionalSpec {
    ...
    CatalogueItem getCatalogueItem() {
        Term.byTerminologyIdAndCode(Utils.toUuid(getModel().id), 'CTT1').get()
    }
